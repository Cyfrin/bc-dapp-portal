...
Feature: Artifacts - UI - Swap
  ...
  Scenario: Check artifacts for the Swap page
    ...
    Then Element with "partial href and text" "'https://battlechain.izumi.finance/swap' and 'iZiSwap'" should be "visible"
    Then Element with "partial href and text" "'https://battlechain.izumi.finance/swap' and 'iZiSwap'" should be "clickable"
    ...
    Then Element with "partial href and text" "'https://swap-battlechain.spacefi.io/#/swap' and 'SpaceFi'" should be "visible"
    Then Element with "partial href and text" "'https://swap-battlechain.spacefi.io/#/swap' and 'SpaceFi'" should be "clickable"
