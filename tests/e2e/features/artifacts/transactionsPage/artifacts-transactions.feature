...
Feature: Artifacts - UI - Transactions - Items
  ...
  Scenario: Check artifacts for the Transaction items
    ...
    Then Element with "href" "/transaction/battlechain/era" should be "visible"
    Then Element with "href" "/transaction/battlechain/era" should be "clickable"
    Then Element with "href" "/transaction/battlechain/era/swap" should be "visible"
    Then Element with "href" "/transaction/battlechain/era/swap" should be "clickable"
