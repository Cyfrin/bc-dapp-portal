...
Feature: Deposit
  ...
  Scenario: Reject Deposit transaction
    ...
    When I click by "text" with "Your account" value
    When I choose "ETH" as token and insert "0.0000000001" as amount
    When I "reject" transaction after clicking "Add funds to Battle Chain Testnet" button
    Then Element with "text" "Add funds to Battle Chain Testnet" should be "visible"
    Then Element with "text" "Add funds to Battle Chain Testnet" should be "clickable"
